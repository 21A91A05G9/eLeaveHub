        ...
        <div className='container-fluid'>
            <div className='row dash  mx-1'>
                ...
                <div className='col-md-11 col-lg-11 col-xl-11 col-sm-10 col-xs-10 box' >
                    ...
                    <div className="row " >
                    <div className='col-md-4 col-lg-3 col-xl-4 col-sm-4 col-xs-4 m-3' >
                        <div className='row leaveCnt' > <Counter/> </div>
                    </div>    

                    <div className='col-md-7 col-lg-8 col-xl-7 col-sm-12 col-xs-12' >
                        <div className='row leaveCnt m-3 pt-4'> <Calender/> </div>
                    </div> 
