  ...
  return (
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
            <input type="email" class="form-control" id="inputEmail22"  value={hoddata.email} onChange={(e)=>sethoddata({...hoddata,email:e.target.value})}/>
            </div>
        </div>
        <div class="row mb-3">
            <label for="inputPassword2" class="col-sm-4 col-form-label">Password</label>
            <div class="col-sm-8">
            <input type="password" class="form-control" id="inputPassword2" value={hoddata.pwd} onChange={(e)=>sethoddata({...hoddata,pwd:e.target.value})}/>
            </div>
        </div>
