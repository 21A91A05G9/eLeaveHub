...
export default function Home() {
    ...
    const handleSTUsubmit=(e)=>{
        ...
        axios.post("http://localhost:5067/handle_student_login",formdata).then((res)=>{
        alert(res.data)
        if(res.data==='Success'){
            ...
            <div class="card text-center col-md-4 col-lg-3 col-xl-2 col-sm-12 col-xs-12 m-3">
                ...
                <div class="container mt-5 mb-4">
                    <form action="/action_page.php " >
                        ...
                        <div class="col-6">
                        <input type="email" name="email" placeholder="Enter Email"  id="email"  size={13}/>
                        </div>
                        </div>
                        <div class="row mb-4">
                        <div class="col-4">
                        ...
                        <div class="col-6">
                        <input type="password" name="pwd" placeholder="Enter password"  id="password"  size={13}  />
                        </div>
                        </div>
                        <button  class="btn btn-success" >Login</button>
                        <p>Don't have a account? <Link to='/register'>Register</Link></p>
