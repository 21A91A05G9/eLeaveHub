...
function HODregister(){
    ...
    return(
        ...
        <div class="card-header"  style={{color:'white'}}>Hod Registration</div>
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                <input type="email" class="form-control" id="inputEmail3"  value={hoddata.email} placeholder="Enter email"  onChange={(e)=>sethoddata({...hoddata,email:e.target.value})}/>
                </div>
            </div>
            <div class="row mb-3">
                <label for="phone3" class="col-sm-4 col-form-label">Phone No.</label>
                <div class="col-sm-8">
                <input type="number" class="form-control" id="phone3"  value={hoddata.phnum} placeholder="Enter phone number"  onChange={(e)=>sethoddata({...hoddata,phnum:e.target.value})}/>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                <input type="password" class="form-control" id="inputPassword3" placeholder="Enter password" value={hoddata.pwd} onChange={(e)=>sethoddata({...hoddata,pwd:e.target.value})}/>
                </div>
            </div>
